<script>
  ...
  // The fit lives in the run window's Score step now, with the labelling and the export it belongs
  // beside. Keeping a second "fit" button here meant two controls for one act, each with its own idea
